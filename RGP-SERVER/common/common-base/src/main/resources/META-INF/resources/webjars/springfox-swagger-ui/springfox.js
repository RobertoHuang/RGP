// 源码修改位置:
//          1.请求/swagger-resources/configuration/ui结束后 修改71行 => data = data.data;
//          2.请求/swagger-resources结束后 修改51行 => data = data.data
//          3.请求/v2/api-docs结束后修改swagger-ui.min.js var n=e.obj => var n=e.obj.data
$(function () {
    var baseUrl;
    var springfox = {
        "getBaseUrl": function () {
