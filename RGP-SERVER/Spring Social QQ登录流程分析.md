...
## OAuth2.0认证流程示意图
![OAuth2.0认证流程示意图](//img-blog.csdn.net/20180508101444324?watermark/2/text/Ly9ibG9nLmNzZG4ubmV0L1JvYmVydG9IdWFuZw==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
```
### 判断是否使用SocialAuthenticationFilter
```
